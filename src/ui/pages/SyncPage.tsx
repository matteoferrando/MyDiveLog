...
export function SyncPage() {
  ...
  return (
    <div className="page">
      ...
      {/*
       * ► LA LINGUA È LA PRIMA RIGA DELLA PAGINA, E NON È UN CAPRICCIO
       *   D'ORDINAMENTO. ◄
       *
       * Chi arriva qui per cambiare lingua non sa leggere le intestazioni delle
       * carte che dovrebbe scorrere per trovarla: è esattamente la persona per
       * cui l'ordine conta di più. Stando in cima, la si trova scorrendo zero.
       */}
      <RigaLingua />
