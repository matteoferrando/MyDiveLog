...
export const INGLESE: Record<string, string> = {
  ...
  'sezione aperta': 'section expanded',
  'sezione chiusa': 'section collapsed',
  'nessuna immersione simile da confrontare': 'no similar dive to compare against',
  'simili, uscita tipica': 'similar, typical surfacing pressure',
  'scenari, lo stesso piano con un parametro cambiato': 'scenarios, the same plan with one parameter changed',
  'il controllo START da fare in superficie': 'the START check to run at the surface',
  'quanto cambia il fondo se respiri di più': 'how bottom time changes if you breathe more',
  'min di soste obbligate': 'min of mandatory stops',
  'Cerca e filtra': 'Search and filter',
  'tutti i siti': 'all sites',
  'per data': 'by date',
  'per profondità': 'by depth',
  'per durata': 'by duration',
  'per consumo': 'by consumption',
